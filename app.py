...
st.set_page_config(
    page_title="HateDetect - Capstone UPN",
    page_icon="🛡️",
    layout="wide",
...
st.sidebar.title("HateDetect")
st.sidebar.caption("Análisis de discurso de odio")
...
with st.sidebar.expander("Acerca del proyecto"):
    st.write("Capstone UPN: clasificación de texto en español e inglés para apoyar la revisión humana en r/Millennials y r/GenZ.")
    st.write("Odio: ataque por un atributo protegido. Ofensivo: agresión verbal sin ese componente. Neutro: no cumple esos criterios.")
    st.caption("El enmascaramiento automático requiere revisión humana. La comunidad no demuestra la edad de sus participantes.")
